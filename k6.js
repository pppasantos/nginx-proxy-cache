...
export default function () {
  ...
  console.info(`🟢 JSON ID: ${id} - Status: ${resJson.status} - X-Cache: ${resJson.headers['X-Cache']}`);
  ...
  console.info(`🟡 IMG ID: ${id} - Status: ${resImg.status} - X-Cache: ${resImg.headers['X-Cache']}`);
